...
namespace GameProject.Game.UsrInt
{
    class SettingsOnGame :Drawable
    {
        ...
        public SettingsOnGame(Player User)
        {
            ...
            Close.setFunction(SetDesactive,"");
            ...
            SaveAndClose.addFuncton(User.Save, "");
            SaveAndClose.addFuncton(MyWindow.window.CloseThis,"");//
        ...
        public void SetDesactive(string a)
        {
            active = false;
        }
